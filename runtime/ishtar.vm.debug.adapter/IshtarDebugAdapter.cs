...
internal class IshtarDebugAdapter : DebugAdapterBase
{
    ...
    private IshtarThread defaultThread;

    #region Constructor

    internal IshtarDebugAdapter(Stream stdIn, Stream stdOut)
    {
    ...
    private IshtarScope CreateGlobalsScope()
    {
        IshtarScope scope = new IshtarScope(this, "Globals", false);
        ...
        directiveInfo.AddChild(new WrapperVariable(this, "DirectiveArguments", null, () => null, () =>
        {
            ...
            if (this.directiveProcessor.IsDirective(line))
            {
                ...
                if (args != null)
                {
                    List<IshtarVariable> argsVars = new List<IshtarVariable>();
    ...
    {
        if (IshtarDebugAdapter.BoolProperties.Contains(args.Name))
        {
            bool boolValue;
    ...
    internal IshtarScope GlobalsScope { get; }
    ...
    protected override ConfigurationDoneResponse HandleConfigurationDoneRequest(ConfigurationDoneArguments arguments)
    {
        ...
        this.defaultThread.PushStackFrame(new IshtarStackFrame(
            adapter: this,
            module: null,
    ...
    private void DebugThreadProc()
    {
        ...
        do
        {
            ...
            IshtarStackFrame currentFrame = this.defaultThread.GetTopStackFrame();
