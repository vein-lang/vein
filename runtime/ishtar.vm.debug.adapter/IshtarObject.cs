...
{
    internal abstract class IshtarObject<TProtocolObject, TFormat>
        where TProtocolObject : class
        where TFormat : class
    {
        protected IshtarObject(IshtarDebugAdapter adapter)
        {
            this.Adapter = adapter;
        }

        protected IshtarDebugAdapter Adapter { get; private set; }
