...
public unsafe partial struct VirtualMachine
{
    ...
    private void A_OP(stackval* sp, int a_t, uint* ip, CallFrame* frame)
    {
        ...
        if (sp->type == TYPE_I4) /*first check int32, most frequent type*/
            act(ref sp[0].data.i, ref sp[-1].data.i, (ref int i1, ref int i2) =>
            {
                switch (a_t)
                {
                    case 0:
            ...
            act(ref sp[0].data.l, ref sp[-1].data.l, (ref long i1, ref long i2) =>
            {
                switch (a_t)
                {
                    case 0:
            ...
            act(ref sp[0].data.s, ref sp[-1].data.s, (ref short i1, ref short i2) =>
            {
                switch (a_t)
                {
                    case 0:
            ...
            act(ref sp[0].data.b, ref sp[-1].data.b, (ref sbyte i1, ref sbyte i2) =>
            {
                switch (a_t)
                {
                    case 0:
            ...
            act(ref sp[0].data.ui, ref sp[-1].data.ui, (ref uint i1, ref uint i2) =>
            {
                switch (a_t)
                {
                    case 0:
            ...
            act(ref sp[0].data.ub, ref sp[-1].data.ub, (ref byte i1, ref byte i2) =>
            {
                switch (a_t)
                {
                    case 0:
            ...
            act(ref sp[0].data.us, ref sp[-1].data.us, (ref ushort i1, ref ushort i2) =>
            {
                switch (a_t)
                {
                    case 0:
            ...
            act(ref sp[0].data.ul, ref sp[-1].data.ul, (ref ulong i1, ref ulong i2) =>
            {
                switch (a_t)
                {
                    case 0:
            ...
            act(ref sp[0].data.f, ref sp[-1].data.f, (ref double i1, ref double i2) =>
            {
                switch (a_t)
                {
                    case 0:
            ...
            act(ref sp[0].data.f_r4, ref sp[-1].data.f_r4, (ref float i1, ref float i2) =>
            {
                switch (a_t)
                {
                    case 0:
            ...
            act(ref sp[0].data.d, ref sp[-1].data.d, (ref decimal i1, ref decimal i2) =>
            {
                switch (a_t)
                {
                    case 0:
