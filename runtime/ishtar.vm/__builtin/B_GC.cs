...
public static unsafe class B_GC
{
    ...
    {
        ffi.Add(ffi.vm.CreateInternalMethod("i_call_GC_get_allocated", Public | Static | Extern)->
            AsNative((delegate*<CallFrame, IshtarObject**, IshtarObject*>)&GetAllocatedBytes));

        ffi.Add(ffi.vm.CreateInternalMethod("i_call_GC_get_alive_objects", Public | Static | Extern)->
