...
[CTypeExport("ishtar_array_block_t")]
public struct ArrayBlock : IEquatable<ArrayBlock>
{
    ...
    public bool Equals(ArrayBlock other) => offset_value == other.offset_value && offset_block == other.offset_block && offset_rank == other.offset_rank && offset_size == other.offset_size;

    public override bool Equals(object obj) => obj is ArrayBlock other && Equals(other);
