namespace mana.lsp
{
    ...
    {
        public const string ApplyEdit = "manaLanguageServer/applyEdit";

        // commands for diagnostic purposes
        internal const string FileContentInMemory = "manaLanguageServer/fileContentInMemory";
        internal const string FileDiagnostics = "manaLanguageServer/fileDiagnostics";
    }
    public class ProtocolError
    {
        ...
        public static ProtocolError AwaitingInitialization =>
            new(Codes.AwaitingInitialization);
    }
    ...
    public static class Workarounds
    {
        ...
        public class CodeActionParams
        {
            ...
            [DataMember(Name = "range")] public Range? Range { get; set; }

            [DataMember(Name = "context")] public CodeActionContext? Context { get; set; }

            public Microsoft.VisualStudio.LanguageServer.Protocol.CodeActionParams? ToCodeActionParams() =>
                this.TextDocument == null
                    ? null
                    : new Microsoft.VisualStudio.LanguageServer.Protocol.CodeActionParams
                    {
                        ...
                        Context = this.Context?.ToCodeActionContext() ??
                                  ...
                                  // context.
                                  new Microsoft.VisualStudio.LanguageServer.Protocol.CodeActionContext
                                  {
        ...
        {
            [DataMember(Name = "diagnostics")] public Diagnostic[]? Diagnostics { get; set; }

            public Microsoft.VisualStudio.LanguageServer.Protocol.CodeActionContext ToCodeActionContext() =>
                new()
                {
