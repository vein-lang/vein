namespace mana.lsp
{
    ...
    public class CompilationUnitManager : IDisposable
    {
        ...
        /// </summary>
        private readonly DocumentDeclaration compilationUnit;
            ...
            string processorArchitecture = "Unspecified")
        {
            ...
            this.compilationUnit = new DocumentDeclaration();
            ...
            var succeeded = this.Processing.QueueForExecution(
                () =>
                {
                    ...
                    if (this.EnableVerification)
                    {
                        ...
                        ManaCompilerError.Verify(task.IsCompleted, "Global type checking hasn't completed.");
                    }
        ...
        private Task QueueGlobalTypeCheckingAsync()
        {
            ...
            return this.Processing.QueueForExecutionAsync(() => ManaCompilerError.RaiseOnFailure(
        ...
        internal T? FileQuery<T>(
            ...
            Func<FileContentManager, DocumentDeclaration, T?> query,
        ...
        public class Compilation
        {
            ...
            /// </summary>
            public ImmutableDictionary<string, ImmutableArray<ImmutableArray<BaseSyntax>>> Tokenization { get; }

            /// <summary>
            /// Contains a dictionary that maps the name of a namespace to the compiled Q# namespace.
            /// </summary>
            public ImmutableDictionary<string, BaseSyntax> SyntaxTree { get; }
            ...
            /// </summary>
            private readonly ImmutableDictionary<string, ImmutableArray<BaseSyntax>> namespaceDeclarations;

            /// <summary>
            /// Contains a dictionary that given the fully qualified name of a compiled callable returns its syntax tree.
            /// </summary>
            public ImmutableDictionary<IdentifierExpression, BaseSyntax> Callables { get; }

            /// <summary>
            /// Contains a dictionary that given the fully qualified name of a compiled type returns its syntax tree.
            /// </summary>
            public ImmutableDictionary<IdentifierExpression, BaseSyntax> Types { get; }
