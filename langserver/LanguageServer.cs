namespace wave.langserver
{
    ...
    public class WaveLanguageServer  : IDisposable
    {
        ...
        public WaveLanguageServer(Stream? sender, Stream? reader)
        {
            ...
            this.fileEvents.Subscribe(fileEvents, ProcessFileEvents);
        ...
        public object Initialize(JToken arg)
        {
            ...
            this.fileWatcher.ListenAsync(this.workspaceFolder, true, dict => 
                this.InitializeWorkspaceAsync(dict), "*.wproj", "*.dll", "*.wave").Wait(); // not strictly necessary to wait but less confusing
        ...
        public Task OnTextDocumentDidCloseAsync(JToken arg)
        {
            ...
            return Task.CompletedTask;//return this.editorState.CloseFileAsync(param.TextDocument, this.LogToWindow);
        }
        ...
        public Task OnTextDocumentDidSaveAsync(JToken arg)
        {
            ...
            return Task.CompletedTask;//return this.editorState.SaveFileAsync(param.TextDocument, param.Text);
        }
        ...
        public Task OnTextDocumentChangedAsync(JToken arg)
        {
            ...
            return Task.CompletedTask;//return this.editorState.DidChangeAsync(param);
        }
        ...
        public object OnTextDocumentDefinition(JToken arg)
        {
            ...
            var defaultLocation = new Location
            {
                ...
                Range = param?.Position != null
                    ? new Microsoft.VisualStudio.LanguageServer.Protocol.Range { Start = param.Position, End = param.Position }
                    : null
            };
            try
            {
